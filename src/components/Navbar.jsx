        ...
        <>
            <nav className='p-4 mx-8'>
                <div className='flex items-center justify-between'>
                    <h1 className='text-gray-800 hover:text-gray-950 text-2xl font-bold mr-10 cursor-pointer'>Book System <span className='font-semibold text-sm'>E-Book Store</span> </h1>
